...
public class Loyaltycard {
	...
	public static Multi<Loyaltycard> findByCustomerId(MySQLPool client, Long idCustomer) {
		return client
				.preparedQuery("SELECT id, idCustomer, idShop FROM LoyaltyCards WHERE idCustomer = ? ORDER BY id ASC")
